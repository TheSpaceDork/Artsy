      ...
      <div className='px-4 lg:px-32 pb-10 w-screen min-h-[120vh]'>
          ...
          <div className='border border-1 border-white lg:border-black w-full lg:w-[45rem] min-h-[35rem]  mx-auto flex flex-col lg:flex-row'>
              <div className='inline-block px-4 py-6 w-full lg:w-[45%] h-[35rem] border-r border-r-1 border-white lg:border-r-black'>
                  <img src={stripe} alt="" className='object-cover w-full h-full' />
              </div>
              <div className='inline-block h-full w-full lg:w-[55%]'>
                  <div className='flex justify-between h-[4rem] items-center border-b-1 border-b border-b-black px-6'>
                      ...
                      <div className='space-x-3'><i className="fa-brands fa-ethereum text-lg"></i><span>0.04 </span></div>
                  </div>
                  <div className='px-4 py-7 border-b border-b-black'>
                      <p className='text-lg mb-4'>Creator : &nbsp;<span className='text-[#4693ED] text-xl'>Helen Paul</span></p>
                      <p className='text-sm mb-4'>Made in Trench</p>
                      <p className='text-lg mb-4'>Total views : &nbsp;<span className=' text-xl'>1.9k views</span></p>
          ...
          <div className='w-full lg:w-[45rem] mx-auto mt-16 drop-shadow-lg rounded-lg px-4 py-4 flex justify-between items-center bg-white'>
              ...
              <div className='flex items-center space-x-6'>
               <Link to="/marketplace/p1"> <div className='border border-black rounded-full w-8 h-8 flex justify-center items-center cursor-pointer'><i className="fa-solid fa-chevron-left text-lg"></i></div></Link>
                 <Link to="/marketplace/p3"> <div className='border border-black rounded-full w-8 h-8 flex justify-center items-center cursor-pointer'><i className="fa-solid fa-chevron-right text-lg "></i></div></Link>
